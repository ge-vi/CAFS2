...
console.log("iki 100", ProductFilters.filterByPrice(currentProducts, 100, ProductFilters.priceFilterOptions().to));
console.log("nuo 100", ProductFilters.filterByPrice(currentProducts, 100, ProductFilters.priceFilterOptions().from));
